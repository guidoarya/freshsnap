...
import com.daniel.android_freshsnap.api.response.VegetablesItem
...
class ListVegetableAdapter (private val listVegetable: ArrayList<VegetablesItem>) : RecyclerView.Adapter<ListVegetableAdapter.ListViewHolder>() {
    ...
    fun setVegetableData(data: List<VegetablesItem>){
        listVegetable.clear()
